...
public class ClassObjectToCompanionObjectInWholeProjectFix(private val elem: JetObjectDeclaration)
    : JetWholeProjectModalAction<JetObjectDeclaration, Collection<JetObjectDeclaration>>(elem, JetBundle.message("migrate.class.object.to.companion.in.whole.project")) {
